...
function Registration() {
    ...
    async function sendData(e) {
        ...
        if (!selectedOption) {
            ...
            customSwal('Error!',"Please select User Type.",'warning','Click Here To Register')
            return false;
        }

        if (Name == '') {
            // alert("Please Enter Your Name")
            customSwal('Error!',"Please Enter Your Name",'warning','Click Here To Register')
            return false
        }
        if (Phone == '' && Email == '') {
            // alert("Please Enter Your Phone Number Or Email Address.")
            customSwal('Error!',"Please Enter Your Phone Number Or Email Address.",'warning','Click Here To Register')
            return false
        }
        if (Phone.length !== 10 && Email == '') {
            // alert("Please Enter Your Correct Phone Number Or Email Address.")
            customSwal('Error!',"Please Enter Your Correct Phone Number Or Email Address.",'warning','Click Here To Register')
            return false
        }
        if (Password == '') {
            // alert("Please Re-Enter Your Password")
            customSwal('Error!',"Please Re-Enter Your Password",'warning','Click Here To Register')
            return false
        }
        if (ConformPass != Password) {
            // alert("Please Match The Password")
            customSwal('Error!',"Please Match The Password",'warning','Click Here To Register')
            return false
        }
        if (!isChecked) {
            // alert('Please Read Then Check the Tearm And Condition Checkbox.');
            customSwal('Error!',"Please Read Then Check the Tearm And Condition Checkbox.",'warning','Click Here To Register')
            return;
        }
        ...
        if(res && res.result){
            customSwal('success!',res.message,'success','Click To Login')
            navigate("/login")
        }
        else{
            customSwal('Error!',res.message,'warning','Click Here To Register')
        }
        console.log("res", res);
    }
